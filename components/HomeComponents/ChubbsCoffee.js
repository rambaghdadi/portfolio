...
const ChubbsCoffee = (props) => (
	<svg
		xmlns="http://www.w3.org/2000/svg"
		id="chubbs-coffee"
		data-name="Chubbs Coffee"
	...
	>
		<defs>
			<style>
				{
					".clss--1,.clss--6{fill:#ffa600;}.clss--1,.clss--4,.clss--7{fill-rule:evenodd;}.clss--2,.clss--3,.clss--5{fill:none;stroke-linecap:round;stroke-width:0.57px;}.clss--2,.clss--5{stroke:#000;}.clss--2,.clss--3{stroke-miterlimit:22.93;}.clss--3{stroke:#373435;}.clss--5{stroke-linejoin:round;}.clss--7{fill:#fefefe;}"
				}
			</style>
		</defs>
		...
		<path
			...
			d="M91.73,103.69h28.5a2,2,0,0,1,0,4H91.73a2,2,0,1,1,0-4Z"
		/>
		<line className="clss--2" x1={91.46} y1={80.14} x2={135.3} y2={80.14} />
		<path
			className="clss--4"
		...
		/>
		<path className="clss--2" d="M123,139a13.52,13.52,0,0,0,4.64.47" />
		<path className="clss--2" d="M120.5,141.69a13.46,13.46,0,0,0,4.63.47" />
		<path
			className="clss--4"
		...
		<line className="clss--2" x1={124.96} y1={135.62} x2={121.01} y2={135.13} />
	</svg>
)

export default ChubbsCoffee
