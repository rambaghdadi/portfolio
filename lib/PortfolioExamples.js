const examples = [
	{
		...
		main: "This website was built using NextJS. Firestore was used as a database to provide an admin page which can perform CRUD operations on the gallery artworks. Firebase was used for Authentication. Both SSR and ISR were implemented",
	...
	},
	{
		...
		main: "This SPA is being built using NextJS. New functionality will be added periodically, so feel free to check back again for updated progress. Firestore was used as a database for the todos. Authentication will be added using Firebase.",
