const examples = [
  {
    ...
    main: `This SPA was built using NextJS. Backend tech included Prisma and PostgreSQL, and the database is hosted on render.com. Ably was used to provide real-time communication when voting on polls. Optional login functionality was added to allow for more secure polls.`,
