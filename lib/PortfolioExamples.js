const examples = [
  {
    ...
    main: `This SPA was built using NextJS. Backend tech included Prisma and PostgreSQL, and the database is hosted on render.com. An optional login functionlity was added to allow for more secure polls.`,
