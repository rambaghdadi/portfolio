const examples = [
	...
	},
	{
		...
		main: "This SPA is being built using NextJS. New functionality will be added periodically, so feel free to check back again for updated progress. The data is fetched from a public API.",
