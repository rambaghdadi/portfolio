const examples = [
  {
    ...
    main: `This SPA was built using NextJS. ExpressJS was used for the backend API while PostgreSQL was used as the database. Please note that the server is temporarily deployed on a free tier with cold starts, so it might take a minute to create/view a poll.`,
